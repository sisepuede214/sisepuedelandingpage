...
const messagesEn = {
  ...
  hero: {
    ...
    preorderLine: 'Pre-orders open July 4.',
  },
  countdown: {
    aria: 'Countdown to July 4th pre-orders',
    days: 'Days',
    hours: 'Hrs',
    minutes: 'Mins',
    seconds: 'Secs',
  ...
  signupForm: {
    ...
    smsNote: "We'll text you first when pre-orders open July 4th.",
...
const messagesEs = {
  ...
  hero: {
    ...
    preorderLine: 'Preventas abren el 4 de julio.',
  },
  countdown: {
    aria: 'Cuenta regresiva para preventas del 4 de julio',
    days: 'Días',
    hours: 'Hrs',
    minutes: 'Min',
    seconds: 'Seg',
  ...
  signupForm: {
    ...
    smsNote: 'Te avisamos por SMS cuando abran las preventas el 4 de julio.',
